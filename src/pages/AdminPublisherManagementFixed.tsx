...
const AdminPublisherManagementFixed = () => {
  ...
  const fetchPublishers = async () => {
    try {
      ...
      console.log('Publishers data:', data); // Debug log
  ...
  const fetchPublisherDetails = async (publisherId: string) => {
    try {
      console.log('Fetching details for publisher ID:', publisherId); // Debug log
      ...
      console.log('Publisher details:', publisherDetails); // Debug log
  ...
  const openActionDialog = async (publisher: Publisher, action: typeof actionType) => {
    console.log('Opening action dialog:', action, 'for publisher:', publisher.username); // Debug log
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Publisher Management (Fixed)</h2>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Publishers ({publishers.length})</CardTitle>
          <CardDescription>
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-t pt-6">
                    <h3 className="text-lg font-medium mb-4">
                      Placements ({selectedPublisher.placements?.length || 0})
                    </h3>
                            ...
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  {placement.platformType} • {placement.currencyName}
                                </p>
                              </div>
                              <Badge 
                                className={
                                  placement.approvalStatus === 'APPROVED' 
