...
export const AnalyticsDashboard: React.FC = () => {
  ...
  const loadAnalytics = async () => {
    try {
      ...
      const analyticsResponse = await fetch(`${API_BASE_URL}/api/analytics/dashboard?date_range=${dateRange}`, {
        headers
      });
      ...
      // Load fraud report
      const fraudResponse = await fetch(`${API_BASE_URL}/api/analytics/fraud-report?date_range=${dateRange}`, {
        headers
      });
