              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-2 flex-wrap">
                  <span className="text-2xl font-bold text-emerald-400">
                    {(offer as any).payout_type === 'percentage' || (offer as any).revenue_share_percent > 0 ? `${(offer as any).revenue_share_percent || offer.payout || 0}%` : `${getCurrencySymbol(offer.currency)}${offer.payout.toFixed(2)}`} <span className="text-sm font-normal text-white/50">{(offer as any).payout_type === 'percentage' || (offer as any).revenue_share_percent > 0 ? 'Rev Share' : (offer.currency || 'USD')}</span>
                  </span>
            ...
            <GlassCard>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-bold text-emerald-400">{(offer as any).payout_type === 'percentage' || (offer as any).revenue_share_percent > 0 ? `${(offer as any).revenue_share_percent || offer.payout || 0}%` : `${getCurrencySymbol(offer.currency)}${offer.payout.toFixed(2)} ${offer.currency || 'USD'}`}</span>
                </div>
                <div className="flex justify-between items-center">
