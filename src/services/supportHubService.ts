...
class SupportHubService {
  ...
  async bulkSend(userIds: string[], templateId: string, channel: string, scheduledTime?: string, emailSettings?: any, messagePrefix?: string, userOffers?: any[]): Promise<any> {
  ...
  async sendOutreach(userId: string, subject: string, body: string, channel: string, scheduledAt?: string, emailSettings?: any, userOffers?: any[]): Promise<any> {
