    ...
    try:
        ...
        for f in funnels:
            ...
            result.append({
                ...
                'vertical': f.get('display_category', 'SURVEY'),
                # Use display_payout first, fall back to offer-level payout field
                'payout': float(f.get('display_payout') or f.get('payout', 0) or 0),
                'payout_type': 'CPA',
                ...
                'image_url': f.get('display_image_url', f.get('image_url', '')),
                'created_at': created_at_str,
                'linked_offer_id': f.get('linked_offer_id'),
                # All offer-level fields for pre-population in Publish modal
                'display_payout': float(f.get('display_payout') or f.get('payout', 0) or 0),
                'display_title': f.get('display_title', f.get('name', '')),
                'display_description': f.get('display_description', ''),
                'display_image_url': f.get('display_image_url', f.get('image_url', '')),
                ...
                'offer_type_field': f.get('offer_type', 'CPA'),
